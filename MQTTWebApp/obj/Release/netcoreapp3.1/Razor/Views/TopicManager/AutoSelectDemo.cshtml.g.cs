#pragma checksum "C:\Users\Truong\Desktop\netzero\MQTTWebApp\Views\TopicManager\AutoSelectDemo.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "19daef26338f46caa47f3ad36375822fc95a44ad"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"19daef26338f46caa47f3ad36375822fc95a44ad", @"/Views/TopicManager/AutoSelectDemo.cshtml")]
...
");
  ...
  ");
    ...
    <script>
        ...
        $.get(`/TopicManager/GetSensorDataCustom?JSONSensorList=[""B351879CB634"",""B2F187F2B634""]&date=1672888939`).then((res) => {
            warningresult = JSON.parse(res)
            console.log(warningresult)
       ...
       ");
                WriteLiteral(@"         ],
                columnDefs: [
                    { width: 80, targets: 0, className: 'dt-body-center'},
            ...
            $('#w");
                WriteLiteral(@"arningTable').DataTable().draw();
    ...
    <script type=""text/javascript"">
        ...
        /*   var config = {
               grid: {
                   ...
                   columns: [
                       { field: 'N");
                WriteLiteral(@"ickName', text: 'NickName', size: '100px' },
                       { field: 'Vendor', text: 'Vendor', size: '100px', searchable: 'text' },
